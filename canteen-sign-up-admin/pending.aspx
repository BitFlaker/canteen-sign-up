...
<asp:Content ID="cttPage" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div class="centerContainer">
        <asp:GridView ID="gvStudentsData" runat="server" OnRowDataBound="GridViewStudentsData_RowDataBound" SkinID="controlGridView" CellPadding="4" ForeColor="#333333" GridLines="None">
