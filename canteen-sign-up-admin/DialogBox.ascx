...
<div id="background">
    <div id="dialogWindow" style="text-align: center;">
        ...
        <div style="display: block;">
            <asp:Button ID="btnOk" runat="server" Text="Ok" OnClick="btnOk_Click"  CssClass="ActionButton SmallPadding" Height="25" />
            <asp:Button ID="btnCancel" runat="server" Text="Abbrechen" OnClick="btnCancel_Click" CssClass="ActionButton SmallPadding" Height="25"/>
        </div>
    </div>
</div>